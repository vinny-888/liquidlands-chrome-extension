        ...
        headups.innerHTML = `
            <div style="background-color:white;z-index:1000;padding:0px;border: 1px solid #fff;">
                ...
                <div id="iframe_div" style="width: 520px;height: 600px;">
                    <iframe style="display: block;width:100%;height: 100%;" src="${base_url}/items/item_small.html?v=0.5&item=${itemName}&cities=${citiesStr}&items=${items}&quantity=${quantity}"></iframe>
                </div>
            </div>`;
